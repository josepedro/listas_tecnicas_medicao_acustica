...
% [K] - Temperatura do Ambiente de Medicao
temperatura_ambiente = 25+273.15;      
% [m/s] - Velocidade do Som no Ar                                                        
velocidade_som = 343.2*sqrt(temperatura_ambiente/293);
% Constante para o Calculo da Freq. de Corte
constante_frequencia_corte = 0.5;
% [m] - Diametro Interno do Tudo
diametro_tubo_interno = 0.027;
% [m] - Distancia do Microfone mais Distante a Amostra em Teste
distancia_microfone_distante = 0.0673;
% [m] - Distancia entre os Dois Microfones
distancia_entre_microfones = 0.024;                                                                  
% [m] - Distancia da Amostra ao Microfone mais Proximo
distancia_microfone_perto = distancia_microfone_distante - distancia_entre_microfones;                                                                  
% [Hz] - Frequencia de Corte do Tubo de Impedancia, para esta Configuracao de Teste.
...
% Calculo do Coeficiente de Absorcao da La de Vidro (verde)
% Medicao 1
...
legend('Amostra 1: 25.2 mm', ... 
'Amostra 2: 25.8 mm', ... 
'Amostra 3: 25.6 mm', 'Coeficientes Sem Amostra');
title('Coeficientes de Absorcao','FontSize', 22);
xlabel('Frequencia (Hz)','FontSize', 22);
ylabel('Coeficiente de Absorcao \alpha','FontSize', 22);
set(gca,'FontSize', 22);
grid on;
